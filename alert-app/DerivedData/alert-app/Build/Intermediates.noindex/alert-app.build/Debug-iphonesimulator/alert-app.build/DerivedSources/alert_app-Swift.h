...
#ifndef ALERT_APP_SWIFT_H
#define ALERT_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="alert_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9alert_app11AppDelegate")
...
SWIFT_CLASS("_TtC9alert_app13SceneDelegate")
...
SWIFT_CLASS("_TtC9alert_app14ViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordAgainField;
- (void)viewDidLoad;
