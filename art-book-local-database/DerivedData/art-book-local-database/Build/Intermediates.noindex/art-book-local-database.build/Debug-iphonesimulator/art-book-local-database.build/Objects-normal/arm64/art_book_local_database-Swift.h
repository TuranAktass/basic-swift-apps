...
#ifndef ART_BOOK_LOCAL_DATABASE_SWIFT_H
#define ART_BOOK_LOCAL_DATABASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="art_book_local_database",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23art_book_local_database11AppDelegate")
...
SWIFT_CLASS("_TtC23art_book_local_database9DetailsVC")
@interface DetailsVC : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified nameField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified yearField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified artistField;
- (void)viewDidLoad;
- (void)hideKeyboard;
- (void)selectImage;
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
- (IBAction)saveClicked:(id _Nonnull)sender;
...
SWIFT_CLASS_NAMED("Paintings")
@interface Paintings : NSManagedObject
...
@interface Paintings (SWIFT_EXTENSION(art_book_local_database))
...
SWIFT_CLASS("_TtC23art_book_local_database13SceneDelegate")
...
SWIFT_CLASS("_TtC23art_book_local_database14ViewController")
