...
#ifndef BIRTHDATE_NOTE_KEEPER_SWIFT_H
#define BIRTHDATE_NOTE_KEEPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="birthdate_note_keeper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21birthdate_note_keeper11AppDelegate")
...
SWIFT_CLASS("_TtC21birthdate_note_keeper13SceneDelegate")
...
SWIFT_CLASS("_TtC21birthdate_note_keeper14ViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified birthdayLabel;
- (IBAction)save:(id _Nonnull)sender;
- (IBAction)deleteSavedData:(id _Nonnull)sender;
