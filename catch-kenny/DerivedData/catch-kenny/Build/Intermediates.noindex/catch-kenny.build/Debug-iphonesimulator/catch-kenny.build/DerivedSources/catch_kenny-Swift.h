...
#ifndef CATCH_KENNY_SWIFT_H
#define CATCH_KENNY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="catch_kenny",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11catch_kenny11AppDelegate")
...
SWIFT_CLASS("_TtC11catch_kenny13SceneDelegate")
...
SWIFT_CLASS("_TtC11catch_kenny14ViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified highestScoreLabel;
- (void)viewDidLoad;
- (void)onTimerTicked;
- (void)onKennyClicked;
- (void)tryAgain;
