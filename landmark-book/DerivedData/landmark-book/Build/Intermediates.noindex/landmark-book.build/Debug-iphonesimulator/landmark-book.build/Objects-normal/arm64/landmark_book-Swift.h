...
#ifndef LANDMARK_BOOK_SWIFT_H
#define LANDMARK_BOOK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="landmark_book",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13landmark_book11AppDelegate")
...
SWIFT_CLASS("_TtC13landmark_book21DetailsViewController")
@interface DetailsViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified landmarkLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified landmarkImage;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC13landmark_book13SceneDelegate")
...
SWIFT_CLASS("_TtC13landmark_book14ViewController")
