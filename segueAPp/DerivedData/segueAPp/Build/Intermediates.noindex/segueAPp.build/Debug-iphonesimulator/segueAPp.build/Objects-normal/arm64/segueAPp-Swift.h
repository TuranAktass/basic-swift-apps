...
#ifndef SEGUEAPP_SWIFT_H
#define SEGUEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="segueAPp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8segueAPp11AppDelegate")
...
SWIFT_CLASS("_TtC8segueAPp13SceneDelegate")
...
SWIFT_CLASS("_TtC8segueAPp20SecondViewController")
...
SWIFT_CLASS("_TtC8segueAPp14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified nameField;
- (IBAction)nextClicked:(id _Nonnull)sender;
