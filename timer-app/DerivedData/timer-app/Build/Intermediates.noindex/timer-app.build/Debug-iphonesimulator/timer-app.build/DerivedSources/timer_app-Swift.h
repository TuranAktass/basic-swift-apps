...
#ifndef TIMER_APP_SWIFT_H
#define TIMER_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="timer_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9timer_app11AppDelegate")
...
SWIFT_CLASS("_TtC9timer_app13SceneDelegate")
...
SWIFT_CLASS("_TtC9timer_app14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified counterField;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified timeLabel;
- (void)viewDidLoad;
- (IBAction)onChanged:(id _Nonnull)sender;
- (IBAction)stopClicked:(id _Nonnull)sender;
- (IBAction)startClicked:(id _Nonnull)sender;
- (IBAction)restartClicked:(id _Nonnull)sender;
- (void)timerFunction;
